...
(function(vue) {
  ...
  var o = function() {
    ...
    return t2.prototype.setPlatform = function(t3, e2) {
      null != this.platform && formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Platform " + this.platformName + " has already been set. Overwriting the platform with " + e2 + "."), this.platformName = t3, this.platform = e2;
      ...
      if (this.flagRegistry[t3] = { evaluationFn: e2, setHook: n2 }, null != this.urlFlags[t3]) {
        ...
        formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Setting feature override from URL " + t3 + ": " + r2 + "."), this.set(t3, r2);
      }
  ...
  function p(t2) {
    ...
    c.has(e2) && formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Overriding the gradient for '" + e2 + "'"), c.set(e2, t2);
  }
  function g(t2, e2) {
    return e2 + "_" + t2;
  }
          ...
          !function(t4, e3, n4) {
            ...
            for (var r4 = 0; r4 < t4.length; r4++) {
              ...
              if (isNaN(o3) || !isFinite(o3))
                return formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Found " + o3 + " in the result of '" + n4 + "'"), true;
            }
  ...
  var ct = function() {
    ...
    return t2.prototype.logKernelProfile = function(t3, e2, n2, r2, o2, a2) {
      ...
      formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "%c" + s2 + "	%c" + i2 + "	%c" + u2 + "D " + l2 + "	%c" + c2 + "	%c" + h2 + "	%c" + a2, "font-weight:bold", "color:red", "color:blue", "color: orange", "color: green", "color: steelblue");
    }, t2;
  }();
  var lt = 20, ht = 3, ft = 7;
    ...
    var o2 = $(e2), a2 = function(t3, e3, n3, r3) {
      ...
      if (u3 > lt) {
        for (var g2 = 0; g2 < ht; g2++) {
          var y = (x2 = g2 * v) + v;
          m.push.apply(m, t3(e3.slice(x2, y), d2, r3, p2, a3, false));
        }
        m.push("...");
        for (g2 = u3 - ht; g2 < u3; g2++) {
          y = (x2 = g2 * v) + v;
          m.push.apply(m, t3(e3.slice(x2, y), d2, r3, p2, a3, g2 === u3 - 1));
        }
      } else
        for (g2 = 0; g2 < u3; g2++) {
          var x2;
  ...
  var Ot, Bt = function() {
    ...
    return t2.prototype.ready = function() {
      ...
      return void 0 === n2 && (n2 = 1), t3 in this.registryFactory ? (formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", t3 + " backend was already registered. Reusing existing backend factory."), false) : (this.registryFactory[t3] = { factory: e2, priority: n2 }, true);
      ...
      try {
        ...
        if (Promise.resolve(r2) === r2) {
          var o2 = ++this.pendingBackendInitId, a2 = r2.then(function(n3) {
            ...
            return !(o2 < e2.pendingBackendInitId) && (e2.pendingBackendInit = null, formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Initialization of backend " + t3 + " failed"), formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", n3.stack || n3.message), false);
          });
          return this.pendingBackendInit = a2, { success: a2, asyncInit: true };
        }
        return this.registry[t3] = r2, { success: true, asyncInit: false };
      } catch (e3) {
        return formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Initialization of backend " + t3 + " failed"), formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", e3.stack || e3.message), { success: false, asyncInit: false };
      }
      ...
      return this.scopedRun(function() {
        ...
        return (n2 = e2()) instanceof Promise && formatAppLog("error", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Cannot return a Promise inside of tidy."), n2;
      });
  ...
  Ut.registerFlag("DEBUG", function() {
    ...
    t2 && formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Debugging mode is ON. The output of every math call will be downloaded to CPU and checked for NaNs. This significantly impacts performance.");
  ...
  function oe(t2, e2, n2) {
    ...
    if (Jt(t2, e2, function() {
      ...
      throw formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", t2.getShaderInfoLog(r2)), new Error("Failed to compile vertex shader.");
    return r2;
  }
  function ae(t2, e2, n2) {
    ...
    if (Jt(t2, e2, function() {
      ...
      throw function(t3, e3) {
        var n3 = ue.exec(e3);
        if (null == n3)
          return formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Couldn't parse line number in error: " + e3), void formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", t3);
        ...
        formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", c2.join("\n")), formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", e3.split("\n")[0]), formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "%c " + N(l2[0], s2), "border:1px solid red; background-color:#e3d2d2; color:#a61717"), formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", h2.join("\n"));
  ...
  function le(t2, e2, n2) {
    if (Jt(t2, e2, function() {
      ...
      throw formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", t2.getProgramInfoLog(n2)), new Error("Failed to link vertex and fragment shaders.");
  }
  function he(t2, e2, n2) {
    if (Jt(t2, e2, function() {
      return t2.validateProgram(n2);
    }), false === t2.getProgramParameter(n2, t2.VALIDATE_STATUS))
      throw formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", t2.getProgramInfoLog(n2)), new Error("Shader program validation failed.");
  }
  ...
  var He = i();
  function Xe(t2) {
    i().getBool("DEPRECATION_WARNINGS_ENABLED") && formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", t2 + " You can disable deprecation warnings with tf.disableDeprecationWarnings().");
  }
  function Ze(t2, e2) {
  ...
  function An(t2) {
    ...
    var o2 = function() {
      ...
      try {
        ...
        return o3 instanceof Promise && formatAppLog("error", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Cannot return a Promise inside of tidy."), Lt.endScope(o3), o3;
      } catch (t4) {
  ...
  var nr = er(function(t2) {
    ...
    !function(e2, n2) {
      ...
      function f2(t3, h3, f3) {
        ...
        })(b2, y, "global" in h3 ? h3.global : this == n2, h3.state);
      }
      function d2(t3) {
  ...
  function pr(t2, e2) {
    void 0 === e2 && (e2 = false), formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", t2.toString(e2));
  }
  ...
  function So(t2, e2, n2, r2, o2, a2, i2, s2) {
    ...
    var d2, p2 = e2[0], v = e2[1], m = e2[3], g2 = To(n2), y = g2[0], x2 = g2[1], b2 = To(r2), w2 = b2[0], E2 = b2[1], R2 = Fo(p2, w2), I2 = Fo(v, E2), k2 = function(t3, e3, n3, r3, o3, a3, i3, s3) {
      var u3, c3, l3;
      if ("number" == typeof t3) {
    ...
    }(o2, l2, h2, y, x2, R2, I2, a2), S2 = k2.padInfo, D2 = k2.outHeight, T2 = k2.outWidth, N2 = i2 ? m * f2 : m;
    return "channelsFirst" === s2 ? d2 = [c2, N2, D2, T2] : "channelsLast" === s2 && (d2 = [c2, D2, T2, N2]), { batchSize: c2, dataFormat: s2, inHeight: l2, inWidth: h2, inChannels: f2, outHeight: D2, outWidth: T2, outChannels: N2, padInfo: S2, strideHeight: y, strideWidth: x2, filterHeight: p2, filterWidth: v, effectiveFilterHeight: R2, effectiveFilterWidth: I2, dilationHeight: w2, dilationWidth: E2, inShape: t2, outShape: d2, filterShape: e2 };
  }
  function Ao(t2, e2, n2, r2, o2, a2, i2, s2) {
    ...
    var p2, v = e2[0], m = e2[1], g2 = e2[2], y = e2[4], x2 = No(n2), b2 = x2[0], w2 = x2[1], E2 = x2[2], R2 = No(r2), I2 = R2[0], k2 = R2[1], S2 = R2[2], D2 = Fo(v, I2), T2 = Fo(m, k2), N2 = Fo(g2, S2), F2 = function(t3, e3, n3, r3, o3, a3, i3, s3, u3, c3, l3) {
      var h3, f3, d3, p3;
      if ("number" == typeof t3) {
        ...
        var m2 = (f3 - 1) * o3 + s3 - e3, g3 = (d3 - 1) * a3 + u3 - n3, y2 = (p3 - 1) * i3 + c3 - r3, x3 = Math.floor(m2 / 2), b3 = m2 - x3, w3 = Math.floor(g3 / 2), E3 = g3 - w3, R3 = Math.floor(y2 / 2);
        h3 = { top: w3, bottom: E3, left: R3, right: y2 - R3, front: x3, back: b3, type: "SAME" };
      } else {
        if ("valid" !== t3)
          throw Error("Unknown padding parameter: " + t3);
    ...
    }(o2, l2, h2, f2, b2, w2, E2, D2, T2, N2, s2), _2 = F2.padInfo, O2 = F2.outDepth, M2 = F2.outHeight, B2 = F2.outWidth, P2 = a2 ? y * d2 : y;
  ...
  function Yo(t2, e2, n2, r2, o2, a2, i2, s2) {
    ...
    for (var u2 = Array.from(e2).map(function(t3, e3) {
      ...
      for (var m = false, g2 = l2.length - 1; g2 >= v; --g2) {
        ...
        if (f2.score = f2.score * Qo(r2, c2, y), f2.score <= o2)
          break;
      }
  ...
  function $o(t2, e2, n2) {
    ...
    if (d2 <= 0 || p2 <= 0)
      return 0;
    var v = Math.max(a2, c2), m = Math.max(i2, l2), g2 = Math.min(s2, h2), y = Math.min(u2, f2), x2 = Math.max(g2 - v, 0) * Math.max(y - m, 0);
    return x2 / (d2 + p2 - x2);
  }
  function Qo(t2, e2, n2) {
  ...
  function ea(t2, e2, n2, r2, o2) {
    for (var a2 = e2[e2.length - 1], i2 = [t2.length / a2, a2], s2 = i2[0], u2 = i2[1], c2 = B(n2, s2 * r2), l2 = B("int32", s2 * r2), h2 = 0; h2 < s2; h2++) {
      ...
      var m = h2 * r2, g2 = c2.subarray(m, m + r2), y = l2.subarray(m, m + r2);
      for (v = 0; v < r2; v++)
        g2[v] = p2[v].value, y[v] = p2[v].index;
    }
    var x2 = e2.slice();
  ...
  var qa = function(t2) {
    ...
    var o2 = t2.padInfo.top, a2 = t2.padInfo.left, i2 = t2.strideHeight, s2 = t2.strideWidth, u2 = t2.dilationHeight, c2 = t2.dilationWidth, l2 = t2.filterHeight, h2 = t2.filterWidth, f2 = 4 * Math.floor(t2.inChannels / 4), d2 = t2.inChannels % 4, p2 = "channelsLast" === t2.dataFormat, v = p2 ? 1 : 2, m = p2 ? 2 : 3, g2 = p2 ? 3 : 1, y = "", x2 = "";
    n2 && (y = r2 ? "float activation(float a) {\n          float b = getPreluActivationWeightsAtOutCoords();\n          " + n2 + "\n        }" : "\n          float activation(float x) {\n            " + n2 + "\n          }\n        ", x2 = "result = activation(result);");
    ...
    var f2 = "bilinear" === r2 ? 1 : 0, d2 = [i2 - 1 + ".0", s2 - 1 + ".0"], p2 = d2[0], v = d2[1], m = l2 > 1 ? ["" + (i2 - 1) / (l2 - 1), "(y2-y1) * height_ratio", "y1*" + p2 + " + float(y)*(height_scale)"] : ["0.0", "0.0", "0.5 * (y1+y2) * " + p2], g2 = m[0], y = m[1], x2 = m[2], b2 = h2 > 1 ? ["" + (s2 - 1) / (h2 - 1), "(x2-x1) * width_ratio", "x1*" + v + " + float(x)*(width_scale)"] : ["0.0", "0.0", "0.5 * (x1+x2) * " + v], w2 = b2[0], C2 = b2[1], E2 = b2[2];
  ...
  var Bi = function() {
    ...
    return Object.defineProperty(t2.prototype, "debug", { get: function() {
      ...
      var t3 = this;
      if (!this.disposed) {
        null != this.program && formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Disposing a GPGPUContext that still has a bound WebGLProgram. This is probably a resource leak, delete the program with GPGPUContext.deleteProgram before disposing."), null != this.outputTexture && formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Disposing a GPGPUContext that still has a bound output matrix texture.  This is probably a resource leak, delete the output matrix texture with GPGPUContext.deleteMatrixTexture before disposing.");
        var e2 = this.gl;
  ...
  var Li = function(t2, e2, n2) {
    ...
    for (var r2 = n2.filterWidth, o2 = n2.inChannels, a2 = n2.strideWidth, i2 = n2.strideHeight, s2 = n2.padInfo, u2 = n2.outWidth, c2 = n2.dilationWidth, l2 = n2.dilationHeight, h2 = n2.dataFormat, f2 = s2.left, d2 = s2.top, p2 = o2 * r2, v = ua(), m = "channelsLast" === h2, g2 = m ? 0 : 1, y = m ? 1 : 2, x2 = "", b2 = 0; b2 <= 1; b2++)
  ...
  var Xi = function(t2, e2, n2) {
    ...
    if (m || (g2 = "-1.0 / 1e-20"), n2)
      ...
      var y = e2 + "(" + e2 + "(" + e2 + "(minMaxValue[0], minMaxValue[1]), minMaxValue[2]), minMaxValue[3])";
      "avg" === e2 && (y = "avgValue / count");
  ...
  var fs = function() {
    ...
    return t2.prototype.acquireTexture = function(t3, e2, n2) {
      ...
      if (this.logEnabled) {
        ...
        formatAppLog("log", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Free/Used", this.numFreeTextures + " / " + this.numUsedTextures, "(" + t3 + ")");
      }
  ...
  var Zs = function(t2) {
    ...
    return e(o2, t2), o2.prototype.numDataIds = function() {
      ...
      return n(this, void 0, void 0, function() {
        var e2, n2, o3, a2, s2, u2, c2, l2, h2, f2, d2, p2, v, m, g2, y, x2, b2, w2, C2, E2, R2;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              ...
              return p2 = null, "complex64" !== u2 && i().get("WEBGL_BUFFER_SUPPORTED") && (v = this.decode(t3), m = this.texData.get(v.dataId), p2 = (R2 = this.gpgpu).createBufferFromTexture.apply(R2, [m.texture].concat(Yt(a2)))), this.pendingRead.set(t3, []), "complex64" === u2 ? [3, 2] : [4, this.gpgpu.createAndWaitForFence()];
            case 1:
              r2.sent(), r2.label = 2;
            case 2:
              return "complex64" !== u2 ? [3, 4] : [4, Promise.all([c2.real.data(), c2.imag.data()])];
            case 3:
              return y = r2.sent(), x2 = y[0], b2 = y[1], g2 = Vo(x2, b2), [3, 5];
            case 4:
      ...
      var e2 = t3.a, n2 = t3.b, r2 = t3.transposeA, o3 = t3.transposeB, a2 = t3.bias, i2 = t3.activation, s2 = t3.preluActivationWeights, u2 = r2 ? e2.shape[2] : e2.shape[1], c2 = o3 ? n2.shape[1] : n2.shape[2], l2 = e2.shape[0], h2 = Dt(e2.dtype, n2.dtype), f2 = null != a2, d2 = null != s2, p2 = i2 ? Qs(i2, true) : null, v = new Hi(e2.shape, [l2, u2, c2], r2, o3, f2, p2, d2), m = [e2, n2];
      ...
      var y = f2 ? s2[0] * s2[1] * (s2[2] + 1) : s2[0] * s2[2] * (s2[3] + 1), x2 = { dataId: t3.dataId, shape: [1, y, n2.inChannels], dtype: t3.dtype }, b2 = u2.shape;
      ...
      }), m && (f2 = this.endTimer(f2), this.activeTimers.push({ name: t3.constructor.name, query: this.getQueryTime(f2) })), !i().getBool("WEBGL_LAZILY_UNPACK") && u2.isPacked && false === o3) {
      ...
      if (null == i2) {
        ...
        if (null == h2 && (h2 = Ne(r2, u2), n2.texShape = h2), null != a2) {
          ...
          var y = this.runWebGLProgram(d2, [g2], o3, null, true), x2 = this.texData.get(y.dataId);
          n2.texture = x2.texture, n2.texShape = x2.texShape, n2.isPacked = x2.isPacked, n2.usage = x2.usage, this.disposeData(g2.dataId), this.texData.delete(y.dataId), n2.values = null, l2 && (this.uploadWaitMs += et() - c2);
        } else {
      ...
      if (this.numBytesInGPU += this.computeBytes(t3, n2), !this.warnedAboutMemory && this.numBytesInGPU > 1024 * this.numMBBeforeWarning * 1024) {
        ...
        this.warnedAboutMemory = true, formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "High memory usage in GPU: " + o3 + " MB, most likely due to a memory leak");
      }
  ...
  var Lc = An({ gather_: function(t2, e2, n2) {
    ...
    return Lt.runKernelFunc(function(t3, e3) {
      ...
      var o3 = e3[0];
      return { x: function() {
        var e4 = r2.shape, a3 = o3.size, i2 = e4.slice(0, n2), s2 = i2.length, u2 = e4.slice(n2, e4.length).slice(1), c2 = u2.length, l2 = Bc(0, s2), h2 = Bc(s2 + 1, s2 + 1 + c2), f2 = Pc([i2, [a3], u2]), d2 = t3.reshape(f2), p2 = o3.reshape([a3]), v = Pc([[s2], l2, h2]), m = d2.transpose(v), g2 = Wc(m, p2, r2.shape[n2]), y = Rn(v);
        return g2 = g2.transpose(y);
      }, indices: function() {
        return o3;
      } };
  ...
  var el = An({ matMul_: function(t2, e2, n2, r2) {
    ...
    var v = a2.shape.slice(0, -2).concat([c2, l2]), m = n2 ? a2.as3D(d2, s2, c2) : a2.as3D(d2, c2, s2), g2 = r2 ? i2.as3D(p2, l2, u2) : i2.as3D(p2, u2, l2), y = { transposeA: n2, transposeB: r2 };
    return Lt.runKernelFunc(function(t3, e3) {
  ...
  var hl = An({ maxPool_: function(t2, e2, n2, r2, o2) {
    ...
    var f2 = 1 === h2[0] && 1 === h2[1], d2 = function(t3, e3, n3) {
      ...
      return [u3, c3];
    }([l2.inHeight, l2.inWidth], h2, c2), p2 = d2[0], v = d2[1], m = f2 ? r2 : "valid", g2 = f2 ? s2 : Mr(s2, h2, p2), y = ("avg" === n2 ? function() {
      ...
      for (var n2 = t2.shape[0], r2 = t2.shape[1], o2 = Cr(n2), a2 = t2.clone(), i2 = Bn([[1]], [1, 1]), s2 = i2.clone(), u2 = n2 >= r2 ? r2 : n2, c2 = function(t3) {
        ...
        e3 = Lt.tidy(function() {
          ...
          if (0 === t3)
            ...
            var y = g2.sub(g2.matMul(s2).matMul(v.transpose()));
            o2 = o2.slice([0, 0], [n2, t3]).concat(y, 1);
          }
          return [s2, a2, o2];
  ...
  var Wh = An({ fusedMatMul_: function(t2) {
    ...
    var v = a2 ? d2.shape[d2.rank - 2] : d2.shape[d2.rank - 1], m = s2 ? p2.shape[p2.rank - 1] : p2.shape[p2.rank - 2], g2 = a2 ? d2.shape[d2.rank - 1] : d2.shape[d2.rank - 2], y = s2 ? p2.shape[p2.rank - 2] : p2.shape[p2.rank - 1], x2 = d2.shape.slice(0, -2), b2 = p2.shape.slice(0, -2), w2 = k(x2), E2 = k(b2);
    ...
    var R2, I2, A2 = d2.shape.slice(0, -2).concat([g2, y]), D2 = a2 ? d2.as3D(w2, v, g2) : d2.as3D(w2, g2, v), T2 = s2 ? p2.as3D(E2, y, m) : p2.as3D(E2, m, y);
    ...
    var v = mn(e2, "x", "conv2d"), m = mn(n2, "filter", "conv2d"), g2 = v, y = false;
    3 === v.rank && (y = true, g2 = v.as4D(1, v.shape[0], v.shape[1], v.shape[2])), C(4 === g2.rank, function() {
    ...
    return y ? I2.as3D(I2.shape[1], I2.shape[2], I2.shape[3]) : I2;
    ...
    var v = mn(e2, "x", "depthwiseConv2d"), m = mn(n2, "filter", "depthwiseConv2d"), g2 = v, y = false;
    3 === v.rank && (y = true, g2 = v.as4D(1, v.shape[0], v.shape[1], v.shape[2])), C(4 === g2.rank, function() {
  ...
  var Kh = function(t2) {
    ...
    return e(o2, t2), o2.prototype.write = function(t3, e2, n2) {
      ...
      Hh([t3, e2], "matMul");
      for (var o3 = n2 ? t3.shape[1] : t3.shape[2], a2 = n2 ? t3.shape[2] : t3.shape[1], i2 = r2 ? e2.shape[1] : e2.shape[2], s2 = t3.shape[0], u2 = this.readSync(t3.dataId), c2 = this.readSync(e2.dataId), l2 = n2 ? [t3.strides[0], 1, t3.strides[1]] : [t3.strides[0], t3.strides[1], 1], h2 = l2[0], f2 = l2[1], d2 = l2[2], p2 = r2 ? [1, e2.strides[1], e2.strides[0]] : [e2.strides[1], 1, e2.strides[0]], v = p2[0], m = p2[1], g2 = p2[2], y = a2 * i2, x2 = dr([s2, a2, i2], t3.dtype), b2 = x2.values, w2 = this.blockSize, C2 = 0; C2 < s2; C2++)
      ...
      for (var r2 = n2.filterDepth, o3 = n2.filterHeight, a2 = n2.filterWidth, i2 = n2.dilationDepth, s2 = n2.dilationHeight, u2 = n2.dilationWidth, c2 = n2.padInfo.front, l2 = n2.padInfo.left, h2 = n2.padInfo.top, f2 = dr(n2.outShape, t3.dtype), d2 = this.readSync(t3.dataId), p2 = this.readSync(e2.dataId), v = f2.values, m = 0; m < n2.batchSize; ++m)
        for (var g2 = m * t3.strides[0], y = m * f2.strides[0], x2 = 0; x2 < n2.outDepth; ++x2)
          for (var b2 = y + x2 * f2.strides[1], w2 = x2 * n2.strideDepth - c2, C2 = 0; C2 < r2; C2++) {
            var E2 = w2 + C2 * i2;
                ...
                for (var Q2 = $2 - W2, J2 = Math.max(0, Math.ceil(Q2 / B2)), Z2 = Math.min(_2, (I2 + Q2) / B2), tt2 = 0, et2 = H2; et2 < q2; ++et2)
                  for (var nt2 = et2 * O2 - G2, rt2 = X2; rt2 < Y2; ++rt2)
                    for (var ot2 = rt2 * M2 - j2, at2 = J2; at2 < Z2; ++at2)
                      for (var it2 = f2 * U2 + d2 * et2 + p2 * rt2 + v * at2, st = y * (E2 - 1 - nt2) + x2 * (R2 - 1 - ot2) + b2 * (I2 - 1 - (at2 * B2 - Q2)) + w2 * V2, ut2 = 0; ut2 < T2; ++ut2) {
      ...
      for (var r2 = n2.strideHeight, o3 = n2.strideWidth, a2 = n2.filterHeight, i2 = n2.filterWidth, s2 = "channelsLast" === n2.dataFormat, u2 = dr(n2.filterShape, "float32"), c2 = n2.padInfo.left, l2 = n2.padInfo.top, h2 = this.bufferSync(t3), f2 = this.bufferSync(e2), d2 = 0; d2 < a2; ++d2)
        for (var p2 = Math.max(0, Math.ceil((l2 - d2) / r2)), v = Math.min(n2.outHeight, (n2.inHeight + l2 - d2) / r2), m = 0; m < i2; ++m)
          for (var g2 = Math.max(0, Math.ceil((c2 - m) / o3)), y = Math.min(n2.outWidth, (n2.inWidth + c2 - m) / o3), x2 = 0; x2 < n2.inChannels; ++x2)
            for (var b2 = 0; b2 < n2.outChannels; ++b2) {
              for (var w2 = 0, C2 = 0; C2 < n2.batchSize; ++C2)
                for (var E2 = p2; E2 < v; ++E2)
                  for (var R2 = d2 + E2 * r2 - l2, I2 = g2; I2 < y; ++I2) {
                    var k2 = m + I2 * o3 - c2;
      ...
      for (var r2 = n2.strideDepth, o3 = n2.strideHeight, a2 = n2.strideWidth, i2 = n2.filterDepth, s2 = n2.filterHeight, u2 = n2.filterWidth, c2 = dr(n2.filterShape, "float32"), l2 = c2.values, h2 = c2.strides, f2 = h2[0], d2 = h2[1], p2 = h2[2], v = h2[3], m = this.readSync(e2.dataId), g2 = e2.strides, y = g2[0], x2 = g2[1], b2 = g2[2], w2 = g2[3], C2 = this.readSync(t3.dataId), E2 = t3.strides, R2 = E2[0], I2 = E2[1], k2 = E2[2], S2 = E2[3], A2 = n2.padInfo.front, D2 = n2.padInfo.left, T2 = n2.padInfo.top, N2 = 0; N2 < i2; ++N2)
            ...
            for (var U2 = Math.max(0, Math.ceil((D2 - W2) / a2)), V2 = Math.min(n2.outWidth, (n2.inWidth + D2 - W2) / a2), z2 = W2 * p2 + L2, G2 = 0; G2 < n2.inChannels; ++G2)
              for (var H2 = G2 * v + z2, q2 = 0; q2 < n2.outChannels; ++q2) {
                for (var K2 = 0, j2 = 0; j2 < n2.batchSize; ++j2)
                  for (var X2 = j2 * R2, Y2 = j2 * y, $2 = F2; $2 < _2; ++$2)
      ...
      for (var r2 = n2.filterHeight, o3 = n2.filterWidth, a2 = n2.dilationHeight, i2 = n2.dilationWidth, s2 = n2.padInfo.left, u2 = n2.padInfo.top, c2 = n2.outChannels / n2.inChannels, l2 = dr(n2.outShape, t3.dtype), h2 = this.readSync(t3.dataId), f2 = this.readSync(e2.dataId), d2 = l2.values, p2 = 0; p2 < n2.batchSize; ++p2)
        for (var v = p2 * t3.strides[0], m = p2 * l2.strides[0], g2 = 0; g2 < n2.outHeight; ++g2)
          for (var y = m + g2 * l2.strides[1], x2 = g2 * n2.strideHeight - s2, b2 = 0; b2 < r2; ++b2) {
            var w2 = x2 + b2 * a2;
            if (!(w2 < 0 || w2 >= n2.inHeight))
              for (var C2 = b2 * e2.strides[0], E2 = v + w2 * t3.strides[1], R2 = 0; R2 < n2.outWidth; ++R2)
                for (var I2 = y + R2 * l2.strides[2], k2 = R2 * n2.strideWidth - u2, S2 = 0; S2 < o3; ++S2) {
                  var A2 = k2 + S2 * i2;
      ...
      for (var r2 = dr(n2.inShape, "float32"), o3 = r2.values, a2 = r2.strides, i2 = a2[0], s2 = a2[1], u2 = a2[2], c2 = this.readSync(t3.dataId), l2 = t3.strides, h2 = l2[0], f2 = l2[1], d2 = l2[2], p2 = this.readSync(e2.dataId), v = e2.strides, m = v[0], g2 = v[1], y = v[2], x2 = n2.batchSize, b2 = n2.filterHeight, w2 = n2.filterWidth, C2 = n2.inChannels, E2 = n2.inHeight, R2 = n2.inWidth, I2 = n2.outChannels, k2 = n2.outHeight, S2 = n2.outWidth, A2 = n2.strideHeight, D2 = n2.strideWidth, T2 = b2 - 1 - n2.padInfo.top, N2 = w2 - 1 - n2.padInfo.left, F2 = I2 / C2, _2 = 0; _2 < x2; ++_2)
            ...
            for (var B2 = M2 - T2, P2 = Math.max(0, Math.ceil(B2 / A2)), L2 = Math.min(k2, (b2 + B2) / A2), W2 = 0; W2 < R2; ++W2) {
              for (var U2 = W2 - N2, V2 = Math.max(0, Math.ceil(U2 / D2)), z2 = Math.min(S2, (w2 + U2) / D2), G2 = 0, H2 = P2; H2 < L2; ++H2)
                for (var q2 = H2 * A2 - B2, K2 = V2; K2 < z2; ++K2)
                  for (var j2 = h2 * _2 + f2 * H2 + d2 * K2, X2 = m * (b2 - 1 - q2) + g2 * (w2 - 1 - (K2 * D2 - U2)) + y * O2, Y2 = 0; Y2 < F2; ++Y2) {
      ...
      for (var r2 = n2.strideHeight, o3 = n2.strideWidth, a2 = n2.filterHeight, i2 = n2.filterWidth, s2 = dr(n2.filterShape, "float32"), u2 = n2.padInfo.left, c2 = n2.padInfo.top, l2 = n2.outChannels / n2.inChannels, h2 = this.bufferSync(t3), f2 = this.bufferSync(e2), d2 = 0; d2 < a2; ++d2)
        for (var p2 = Math.max(0, Math.ceil((c2 - d2) / r2)), v = Math.min(n2.outHeight, (n2.inHeight + c2 - d2) / r2), m = 0; m < i2; ++m)
          for (var g2 = Math.max(0, Math.ceil((u2 - m) / o3)), y = Math.min(n2.outWidth, (n2.inWidth + u2 - m) / o3), x2 = 0; x2 < n2.outChannels; ++x2) {
            for (var b2 = Math.trunc(x2 / l2), w2 = x2 % l2, C2 = 0, E2 = 0; E2 < n2.batchSize; ++E2)
              for (var R2 = p2; R2 < v; ++R2)
                for (var I2 = d2 + R2 * r2 - c2, k2 = g2; k2 < y; ++k2) {
                  var S2 = m + k2 * o3 - u2;
      ...
      for (var r2 = e2.strideHeight, o3 = e2.strideWidth, a2 = e2.dilationHeight, i2 = e2.dilationWidth, s2 = e2.effectiveFilterHeight, u2 = e2.effectiveFilterWidth, c2 = e2.padInfo.top, l2 = e2.padInfo.left, h2 = "max" === n2 ? Number.NEGATIVE_INFINITY : Number.POSITIVE_INFINITY, f2 = this.readSync(t3.dataId), d2 = dr(e2.outShape, t3.dtype), p2 = d2.values, v = e2.outShape[1] * e2.outShape[2] * e2.outShape[3], m = e2.outShape[2] * e2.outShape[3], g2 = e2.outShape[3], y = 0; y < e2.batchSize; ++y)
        for (var x2 = y * v, b2 = y * t3.strides[0], w2 = 0; w2 < e2.inChannels; ++w2)
        ...
        for (var d2 = 0; d2 < e2.inChannels; ++d2)
          for (var p2 = 0; p2 < e2.outHeight; ++p2) {
            for (var v = p2 * r2 - c2, m = v; m < 0; )
              m += a2;
            for (var g2 = Math.min(e2.inHeight, s2 + v), y = 0; y < e2.outWidth; ++y) {
              for (var x2 = y * o3 - l2, b2 = x2; b2 < 0; )
                b2 += i2;
      ...
      for (var o3 = this.maxPoolPositions(e2, r2), a2 = r2.strideHeight, i2 = r2.strideWidth, s2 = r2.dilationHeight, u2 = r2.dilationWidth, c2 = r2.effectiveFilterHeight, l2 = r2.effectiveFilterWidth, h2 = l2 - 1 - r2.padInfo.left, f2 = c2 - 1 - r2.padInfo.top, d2 = dr(e2.shape, "float32"), p2 = this.bufferSync(o3), v = this.bufferSync(t3), m = 0; m < r2.batchSize; ++m)
        for (var g2 = 0; g2 < r2.inChannels; ++g2)
          for (var y = 0; y < r2.inHeight; ++y)
            for (var x2 = 0; x2 < r2.inWidth; ++x2) {
              for (var b2 = y - f2, w2 = x2 - h2, C2 = 0, E2 = 0; E2 < c2; E2 += s2) {
                var R2 = (b2 + E2) / a2;
      ...
      for (var n2 = dr(e2.outShape, "int32"), r2 = e2.strideDepth, o3 = e2.strideHeight, a2 = e2.strideWidth, i2 = e2.dilationDepth, s2 = e2.dilationHeight, u2 = e2.dilationWidth, c2 = e2.effectiveFilterDepth, l2 = e2.effectiveFilterHeight, h2 = e2.effectiveFilterWidth, f2 = e2.padInfo.front, d2 = e2.padInfo.top, p2 = e2.padInfo.left, v = this.bufferSync(t3), m = 0; m < e2.batchSize; ++m)
        for (var g2 = 0; g2 < e2.inChannels; ++g2)
          for (var y = 0; y < e2.outDepth; ++y) {
            for (var x2 = y * r2 - f2, b2 = x2; b2 < 0; )
              b2 += i2;
                      ...
                      if (!(F2 < 0 || F2 >= r2.outHeight || Math.floor(F2) !== F2))
                        for (var _2 = 0; _2 < d2; _2 += l2) {
                          ...
                          if (!(O2 < 0 || O2 >= r2.outWidth || Math.floor(O2) !== O2)) {
                            var M2 = h2 * f2 * d2 - 1 - y.get(b2, T2, F2, O2, w2) === D2 * f2 * d2 + N2 * d2 + _2 ? 1 : 0;
                            if (0 !== M2)
      ...
      for (var o3 = t3.shape, a2 = o3[0], i2 = o3[1], s2 = o3[2], u2 = o3[3], c2 = this.readSync(t3.dataId), l2 = new Float32Array(k([a2, e2, n2, u2])), h2 = [r2 && e2 > 1 ? i2 - 1 : i2, r2 && n2 > 1 ? s2 - 1 : s2], f2 = [r2 && e2 > 1 ? e2 - 1 : e2, r2 && n2 > 1 ? n2 - 1 : n2], d2 = 0, p2 = h2[0] / f2[0], v = h2[1] / f2[1], m = 0; m < a2; m++)
        for (var g2 = 0; g2 < e2; g2++)
          for (var y = p2 * g2, x2 = Math.floor(y), b2 = y - x2, w2 = Math.min(i2 - 1, Math.ceil(y)), C2 = m * t3.strides[0] + x2 * t3.strides[1], E2 = m * t3.strides[0] + w2 * t3.strides[1], R2 = 0; R2 < n2; R2++)
      ...
      for (var r2 = e2.shape, o3 = r2[0], a2 = r2[1], i2 = r2[2], s2 = r2[3], u2 = t3.shape, c2 = u2[1], l2 = u2[2], h2 = new Float32Array(o3 * a2 * i2 * s2), f2 = [n2 && c2 > 1 ? a2 - 1 : a2, n2 && l2 > 1 ? i2 - 1 : i2], d2 = [n2 && c2 > 1 ? c2 - 1 : c2, n2 && l2 > 1 ? l2 - 1 : l2], p2 = f2[0] / d2[0], v = f2[1] / d2[1], m = this.readSync(t3.dataId), g2 = 0, y = 0; y < o3; y++)
        for (var x2 = y * e2.strides[0], b2 = 0; b2 < c2; b2++)
      ...
      for (var o3 = t3.shape, a2 = o3[0], i2 = o3[1], s2 = o3[2], u2 = o3[3], c2 = this.readSync(t3.dataId), l2 = new Float32Array(a2 * e2 * n2 * u2), h2 = [r2 && e2 > 1 ? i2 - 1 : i2, r2 && n2 > 1 ? s2 - 1 : s2], f2 = [r2 && e2 > 1 ? e2 - 1 : e2, r2 && n2 > 1 ? n2 - 1 : n2], d2 = h2[0] / f2[0], p2 = h2[1] / f2[1], v = 0, m = 0; m < a2; m++)
        for (var g2 = m * t3.strides[0], y = 0; y < e2; y++)
          for (var x2 = d2 * y, b2 = g2 + Math.min(i2 - 1, r2 ? Math.round(x2) : Math.floor(x2)) * t3.strides[1], w2 = 0; w2 < n2; w2++)
      ...
      for (var r2 = e2.shape, o3 = r2[0], a2 = r2[1], i2 = r2[2], s2 = r2[3], u2 = t3.shape, c2 = u2[1], l2 = u2[2], h2 = new Float32Array(o3 * a2 * i2 * s2), f2 = this.readSync(t3.dataId), d2 = [n2 && c2 > 1 ? a2 - 1 : a2, n2 && l2 > 1 ? i2 - 1 : i2], p2 = [n2 && c2 > 1 ? c2 - 1 : c2, n2 && l2 > 1 ? l2 - 1 : l2], v = d2[0] / p2[0], m = d2[1] / p2[1], g2 = 1 / v, y = 1 / m, x2 = 2 * Math.ceil(g2) + 2, b2 = 2 * Math.ceil(y) + 2, w2 = 0; w2 < o3; w2++)
        for (var C2 = w2 * e2.strides[0], E2 = 0; E2 < a2; E2++)
          for (var R2 = C2 + E2 * e2.strides[1], I2 = Math.floor(E2 * g2), k2 = Math.floor(I2 - x2 / 2), S2 = 0; S2 < i2; S2++)
            for (var A2 = R2 + S2 * e2.strides[2], D2 = Math.floor(S2 * y), T2 = Math.floor(D2 - b2 / 2), N2 = 0; N2 < s2; N2++) {
      ...
      for (var s2 = t3.shape[3], u2 = this.readSync(t3.dataId), c2 = this.readSync(e2.dataId), l2 = this.readSync(n2.dataId), h2 = new Float32Array(t3.size), f2 = t3.size, d2 = 0; d2 < f2; d2++) {
        for (var p2 = d2 % s2, v = d2 - p2 + Math.max(0, p2 - r2), m = d2 - p2 + Math.min(s2, p2 + r2 + 1), g2 = 0, y = v; y < m; y++)
          g2 += Math.pow(c2[y], 2);
        g2 = a2 * g2 + o3;
        for (y = v; y < m; y++) {
          var x2 = -2 * a2 * i2 * c2[y] * l2[d2] / g2;
          d2 === y && (x2 += Math.pow(g2, -i2)), x2 *= u2[d2], h2[y] += x2;
        }
      }
      return Ln(h2, t3.shape);
    }, o2.prototype.multinomial = function(t3, e2, n2, r2) {
      ...
      for (var r2 = t3.shape[0], o3 = t3.shape[1], a2 = t3.shape[2], i2 = t3.shape[3], s2 = o3 * e2, u2 = a2 * e2, c2 = i2 / (e2 * e2), l2 = this.readSync(t3.dataId), h2 = new Float32Array(r2 * s2 * u2 * c2), f2 = 0, d2 = 0; d2 < r2; ++d2)
        for (var p2 = 0; p2 < s2; ++p2)
          for (var v = Math.floor(p2 / e2), m = p2 % e2, g2 = 0; g2 < u2; ++g2)
            for (var y = Math.floor(g2 / e2), x2 = (m * e2 + g2 % e2) * c2, b2 = 0; b2 < c2; ++b2) {
              var w2 = b2 + x2 + i2 * (y + a2 * (v + o3 * d2));
              h2[f2++] = l2[w2];
            }
      ...
      if (u2.length + c2.length === 0)
        ...
        var m = this.bufferSync(this.data.get(t3.dataId).complexTensors.real), g2 = this.bufferSync(this.data.get(e2.dataId).complexTensors.real), y = function(r3) {
          ...
          var v2 = g2.locToIndex(p3), y2 = n2(i2[2 * d3], i2[2 * d3 + 1], s2[2 * v2], s2[2 * v2 + 1]);
          l2[r3] = y2.real, h2[r3] = y2.imag;
        };
      ...
      for (var i2 = t3.shape, s2 = i2[0], u2 = i2[1], c2 = i2[2], l2 = i2[3], h2 = e2.shape[0], f2 = r2[0], d2 = r2[1], p2 = dr([h2, f2, d2, l2], "float32"), v = this.readSync(e2.dataId), m = this.readSync(n2.dataId), g2 = this.readSync(t3.dataId), y = t3.strides, x2 = p2.strides, b2 = 0; b2 < h2; b2++) {
            ...
            if (T2 < 0 || T2 > u2 - 1)
              ...
              for (N2 = 0; N2 < d2; N2++) {
                if ((q2 = d2 > 1 ? E2 * (c2 - 1) + N2 * A2 : 0.5 * (E2 + I2) * (c2 - 1)) < 0 || q2 > c2 - 1)
                  ...
                  for (F2 = 0; F2 < l2; F2++) {
                    var U2 = g2[_2 = F2 + P2 * y[2] + O2 * y[1] + k2 * y[0]], V2 = g2[_2 = F2 + L2 * y[2] + O2 * y[1] + k2 * y[0]], z2 = g2[_2 = F2 + P2 * y[2] + M2 * y[1] + k2 * y[0]], G2 = U2 + (V2 - U2) * W2, H2 = z2 + (g2[_2 = F2 + L2 * y[2] + M2 * y[1] + k2 * y[0]] - z2) * W2;
              ...
              for (N2 = 0; N2 < d2; ++N2) {
                ...
                if ((q2 = d2 > 1 ? E2 * (c2 - 1) + N2 * A2 : 0.5 * (E2 + I2) * (c2 - 1)) < 0 || q2 > c2 - 1)
                  ...
                  for (F2 = 0; F2 < l2; F2++) {
                    var X2 = F2 + K2 * y[2] + j2 * y[1] + k2 * y[0], Y2 = F2 + N2 * x2[2] + D2 * x2[1] + b2 * x2[0];
                    p2.values[Y2] = g2[X2];
                  }
                }
              }
      ...
      for (var p2 = 0; p2 < a2; p2++) {
        ...
        for (var x2 = 0; x2 < o3; x2++)
          c2 ? d2.values[m * o3 + x2] += f2[p2 * o3 + x2] : d2.values[m * o3 + x2] = 0 === e2.rank ? f2[0] : f2[p2 * o3 + x2];
      }
  ...
  var ed = Object.freeze({ browserFiles: function(t2) {
    ...
    return 1 === arguments.length ? null != t2.modelTopology || null != t2.weightSpecs ? new Zf(t2) : (formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Zf({ modelTopology: t2 })) : (formatAppLog("warn", "at node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js:17", "Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Zf({ modelTopology: t2, weightSpecs: e2, weightData: n2, trainingConfig: r2 }));
  ...
  var nd;
  An({ confusionMatrix_: function(t2, e2, n2) {
  ...
  var ad = An({ fromPixels_: function(t2, e2) {
    ...
    return n(this, void 0, void 0, function() {
      var n2, o2, a2, i2, s2, u2, c2, l2, h2, f2, d2, p2, v, m, g2, y, x2, b2, w2, C2, E2, R2, I2;
      return r(this, function(r2) {
        switch (r2.label) {
          case 0:
          ...
          case 2:
            ...
            for (m = "float32" === n2.dtype ? 255 : 1, g2 = new Uint8ClampedArray(i2 * a2 * 4), y = 0; y < a2 * i2; ++y)
              x2 = void 0, b2 = void 0, w2 = void 0, C2 = void 0, 1 === s2 ? (x2 = u2[y] * m, b2 = u2[y] * m, w2 = u2[y] * m, C2 = 255) : 3 === s2 ? (x2 = u2[3 * y] * m, b2 = u2[3 * y + 1] * m, w2 = u2[3 * y + 2] * m, C2 = 255) : 4 === s2 && (x2 = u2[4 * y] * m, b2 = u2[4 * y + 1] * m, w2 = u2[4 * y + 2] * m, C2 = u2[4 * y + 3] * m), g2[(E2 = 4 * y) + 0] = Math.round(x2), g2[E2 + 1] = Math.round(b2), g2[E2 + 2] = Math.round(w2), g2[E2 + 3] = Math.round(C2);
  ...
  cd(kd);
  "undefined" != typeof requestAnimationFrame ? requestAnimationFrame : "undefined" != typeof setImmediate ? setImmediate : function(t2) {
    return t2();
  };
  ...
  var Box = (
    ...
    function() {
      function Box2(_box, allowNegativeDimensions) {
        ...
        var _a2 = isRect ? [box.x, box.y, box.width, box.height] : [box.left, box.top, box.right - box.left, box.bottom - box.top], x2 = _a2[0], y = _a2[1], width = _a2[2], height = _a2[3];
        Box2.assertIsValidBox({ x: x2, y, width, height }, "Box.constructor", allowNegativeDimensions);
        this._x = x2;
        this._y = y;
        this._width = width;
        this._height = height;
      ...
      Box2.prototype.round = function() {
        ...
        }), x2 = _a2[0], y = _a2[1], width = _a2[2], height = _a2[3];
        return new Box2({ x: x2, y, width, height });
      };
      ...
      Box2.prototype.toSquare = function() {
        var _a2 = this, x2 = _a2.x, y = _a2.y, width = _a2.width, height = _a2.height;
      ...
      Box2.prototype.clipAtImageBorders = function(imgWidth, imgHeight) {
        var _a2 = this, x2 = _a2.x, y = _a2.y, right = _a2.right, bottom = _a2.bottom;
      ...
      Box2.prototype.padAtBorders = function(imageHeight, imageWidth) {
        ...
        return { dy, edy, dx, edx, y, ey, x: x2, ex, w: w2, h: h2 };
      };
  ...
  function minBbox(pts) {
    ...
    var minY = ys2.reduce(function(min, y) {
      return y < min ? y : min;
    }, Infinity);
    var maxX = xs2.reduce(function(max, x2) {
      return max < x2 ? x2 : max;
    }, 0);
    var maxY = ys2.reduce(function(max, y) {
      return max < y ? y : max;
    }, 0);
  ...
  var Rect = (
    ...
    function(_super) {
      ...
      function Rect2(x2, y, width, height, allowNegativeDimensions) {
        if (allowNegativeDimensions === void 0) {
          allowNegativeDimensions = false;
        }
        return _super.call(this, { x: x2, y, width, height }, allowNegativeDimensions) || this;
      }
      return Rect2;
    }(Box)
  );
  ...
  var FaceLandmarks = (
    ...
    function() {
      ...
      FaceLandmarks2.prototype.shiftBy = function(x2, y) {
        return new this.constructor(this.relativePositions, this._imgDims, new Point(x2, y));
      };
      ...
      FaceLandmarks2.prototype.alignDlib = function() {
        ...
        return new Rect(x2, y, Math.min(size, this.imageWidth + x2), Math.min(size, this.imageHeight + y));
      };
        ...
        switch (_b.label) {
          ...
          case 5:
            ...
            return [2, boxes.map(function(_a3) {
              var x2 = _a3.x, y = _a3.y, width = _a3.width, height = _a3.height;
              var faceImg = createCanvas({ width, height });
              getContext2dOrThrow(faceImg).putImageData(ctx.getImageData(x2, y, width, height), 0, 0);
              return faceImg;
            })];
        }
      });
      ...
      return __generator(this, function(_a2) {
        ...
        return [2, Ze(function() {
          ...
          var faceTensors = boxes.map(function(_a4) {
            var x2 = _a4.x, y = _a4.y, width = _a4.width, height = _a4.height;
            return xl(imageTensor.as3D(imgHeight, imgWidth, numChannels), [y, x2, 0], [height, width, numChannels]);
          });
          return faceTensors;
        })];
      });
  ...
  var TinyYolov2Base = (
    ...
    function(_super) {
      ...
      TinyYolov2Base2.prototype.extractBoxes = function(outputTensor, inputBlobDimensions, scoreThreshold) {
        return __awaiter(this, void 0, void 0, function() {
          var width, height, inputSize, correctionFactorX, correctionFactorY, numCells, numBoxes, _a2, boxesTensor, scoresTensor, classScoresTensor, results, scoresData, boxesData, row, col, anchor, score, ctX, ctY, width_1, height_1, x2, y, pos, _b, classScore, label, _c2;
          var _this = this;
          return __generator(this, function(_d) {
            switch (_d.label) {
              case 0:
              ...
              case 8:
                ...
                results.push(__assign({ box: new BoundingBox(x2, y, x2 + width_1, y + height_1), score, classScore: score * classScore, label }, pos));
                _d.label = 9;
              case 9:
                anchor++;
                return [3, 5];
  ...
  function extractBoundingBoxes(scoresTensor, regionsTensor, scale2, scoreThreshold) {
    ...
    for (var y = 0; y < scoresTensor.shape[0]; y++) {
      for (var x2 = 0; x2 < scoresTensor.shape[1]; x2++) {
        if (scoresData[y][x2] >= scoreThreshold) {
          indices.push(new Point(x2, y));
        }
      }
    }
        ...
        switch (_b.label) {
          case 0:
            ...
            return [4, Promise.all(boxes.map(function(box) {
              return __awaiter(_this, void 0, void 0, function() {
                var _a3, y, ey, x2, ex, fromX, fromY, imgData;
                return __generator(this, function(_b2) {
                  _a3 = box.padAtBorders(img.height, img.width), y = _a3.y, ey = _a3.ey, x2 = _a3.x, ex = _a3.ex;
                  fromX = x2 - 1;
                  fromY = y - 1;
  ...
  var Mtcnn = (
    ...
    function(_super) {
      ...
      Mtcnn2.prototype.load = function(weightsOrUrl) {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a2) {
            formatAppLog("warn", "at node_modules/face-api.js/build/es6/mtcnn/Mtcnn.js:27", "mtcnn is deprecated and will be removed soon");
      ...
      Mtcnn2.prototype.loadFromDisk = function(filePath) {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a2) {
            formatAppLog("warn", "at node_modules/face-api.js/build/es6/mtcnn/Mtcnn.js:35", "mtcnn is deprecated and will be removed soon");
  ...
  const _sfc_main$1 = {
    ...
    methods: {
      async loadModels() {
        script.onload = async () => {
          await nets.tinyFaceDetector.loadFromUri("/static/models");
          await nets.faceLandmark68Net.loadFromUri("/static/models");
          await nets.faceRecognitionNet.loadFromUri("/static/models");
          formatAppLog("log", "at pages/index/index.vue:33", "Models loaded");
        };
      }
    }
  };
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "/Users/liufucong/Downloads/face-reg/pages/index/index.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/liufucong/Downloads/face-reg/App.vue"]]);
  function createApp() {
